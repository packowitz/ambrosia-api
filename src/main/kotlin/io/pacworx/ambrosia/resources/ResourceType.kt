...
enum class ResourceType(val category: ResourceTypeCategory) {
    STEAM(BATTLE_FEE), STEAM_MAX(DEFINITION), PREMIUM_STEAM(BATTLE_FEE), PREMIUM_STEAM_MAX(DEFINITION),
    COGWHEELS(BATTLE_FEE), COGWHEELS_MAX(DEFINITION), PREMIUM_COGWHEELS(BATTLE_FEE), PREMIUM_COGWHEELS_MAX(DEFINITION),
    TOKENS(BATTLE_FEE), TOKENS_MAX(DEFINITION), PREMIUM_TOKENS(BATTLE_FEE), PREMIUM_TOKENS_MAX(DEFINITION),

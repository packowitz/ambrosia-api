...
enum class SkillActionEffect(val type: SkillActionType,
    ...
    DEXTERITY_DEBUFF(BUFF, needDuration = true, description = "Grants Dexterity Debuff with value intensity for duration turn", buff = Buff.DEXTERITY_DEBUFF),
    ...
    RESISTANCE_DEBUFF(BUFF, needDuration = true, description = "Grants Resistance Debuff with value intensity for duration turn", buff = Buff.RESISTANCE_DEBUFF),

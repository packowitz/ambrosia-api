...
enum class SkillActionEffect(val type: SkillActionType,
    ...
    CRIT_RESIST_BUFF(BUFF, needDuration = true, description = "Grants Crit Resist Buff with value intensity for duration turn", buff = Buff.CRIT_RESIST_BUFF),
    ...
    DAMAGE_REDUCTION_BUFF(BUFF, needDuration = true, description = "Grants Damage Reduction Buff with value intensity for duration turn", buff = Buff.DAMAGE_REDUCTION_BUFF),
    ...
    DEXTERITY_BUFF(BUFF, needDuration = true, description = "Grants Dexterity Buff with value intensity for duration turn", buff = Buff.DEXTERITY_BUFF),
    ...
    RESISTANCE_BUFF(BUFF, needDuration = true, description = "Grants Resistance Buff with value intensity for duration turn", buff = Buff.RESISTANCE_BUFF),
    ...
    DEXTERITY_DEBUFF(DEBUFF, needDuration = true, description = "Grants Dexterity Debuff with value intensity for duration turn", buff = Buff.DEXTERITY_DEBUFF),
    ...
    MARKED_DEBUFF(DEBUFF, needDuration = true, description = "Applies Marked Debuff with value intensity for duration turn", buff = Buff.MARKED),
    ...
    RESISTANCE_DEBUFF(DEBUFF, needDuration = true, description = "Grants Resistance Debuff with value intensity for duration turn", buff = Buff.RESISTANCE_DEBUFF),
    ...
    DAMAGE_REDUCTION_PASSIVE(PASSIVE_STAT, description = "Decreases passively the percentage of damage the hero receives", stat = HeroStat.DAMAGE_REDUCTION),

...
enum class SkillActionEffect(val type: SkillActionType,
    ...
    DEXTERITY_BUFF(BUFF, needDuration = true, description = "Grants Dexterity Buff with value intensity for duration turn", buff = Buff.DEATHSHIELD),
    ...
    RESISTANCE_BUFF(BUFF, needDuration = true, description = "Grants Resistance Buff with value intensity for duration turn", buff = Buff.DEATHSHIELD),
    ...
    DEXTERITY_DEBUFF(BUFF, needDuration = true, description = "Grants Dexterity Debuff with value intensity for duration turn", buff = Buff.DEATHSHIELD),
    ...
    RESISTANCE_DEBUFF(BUFF, needDuration = true, description = "Grants Resistance Debuff with value intensity for duration turn", buff = Buff.DEATHSHIELD),

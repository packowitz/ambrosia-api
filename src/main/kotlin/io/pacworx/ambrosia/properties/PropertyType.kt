...
enum class PropertyType(
    ...
    BARRACKS_BUILDING(BUILDING, "Defines the increase of barrack's capacity for reaching each level."),
    ...
    ACADEMY_BUILDING(BUILDING, "Defines the max level of a hero that can be trained and evolved in the academy", value1name = "MaxTrainLvl"),
    GARAGE_BUILDING(BUILDING, "Defines the increase of garage's capacity for unused vehicles and parts", value1name = "VehicleStorage", showValue2 = true, value2name = "PartsStorage"),
    LABORATORY_INCUBATORS(BUILDING, "Defines the increase of dna cubes for reaching each laboratory level"),
    LABORATORY_SPEED(BUILDING, "Defines the speed increase for hero cloning in the laboratory"),
    JEWELRY_BUILDING(BUILDING, "Defines the max level that can be upgraded in the jewelry"),
    FORGE_MOD_RARITY(BUILDING, "Defines the max rarity (1-6) that can be modified in the forge"),
    FORGE_MOD_SPEED(BUILDING, "Defines the speed increase for modifications in the forge"),
    FORGE_BREAKDOWN_RARITY(BUILDING, "Defines the max rarity (1-6) that can be broken down in the forge"),
    FORGE_BREAKDOWN_RES(BUILDING, "Defines the increase for gained resources when breaking down gear in the forge"),
    FORGE_REROLL_QUAL(BUILDING, "Indicates with which forge level it is possible to re roll gear quality. Set value to 1 for that level"),
    FORGE_REROLL_STAT(BUILDING, "Indicates with which forge level it is possible to re roll gear main stat. Set value to 1 for that level"),
    FORGE_INC_RARITY(BUILDING, "Indicates with which forge level it is possible to increase gear rarity. Set value to 1 for that level"),
    FORGE_REROLL_JEWEL(BUILDING, "Indicates with which forge level it is possible to re roll a jewel slot. Set value to 1 for that level"),
    FORGE_ADD_JEWEL(BUILDING, "Indicates with which forge level it is possible to add a jewel slot to gear. Set value to 1 for that level"),
    FORGE_ADD_SP_JEWEL(BUILDING, "Indicates with which forge level it is possible to add a special jewel slot to gear. Set value to 1 for that level"),
